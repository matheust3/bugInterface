...
// in assist_agro/test/features/admin/data/repositories/admin_repository_impl_test.dart.
...
class _FakeLoginResponseData extends _i1.Fake implements _i2.LoginResponseData {
}
...
class MockLoginDatasource extends _i1.Mock implements _i3.LoginDatasource {
  ...
  @override
  _i4.Future<_i2.LoginResponseData> login(
          {_i5.LoginRequestData? requestData}) =>
      (super.noSuchMethod(
              Invocation.method(#login, [], {#requestData: requestData}),
              returnValue: Future.value(_FakeLoginResponseData()))
          as _i4.Future<_i2.LoginResponseData>);
}
